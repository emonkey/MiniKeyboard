...
namespace HidLibrary
{
	public class HidFastReadDevice : HidDevice
	{
		...
		public HidDeviceReport FastReadReport()
		{
			return FastReadReport(0);
		}

		public HidDeviceReport FastReadReport(int timeout)
		{
			return new HidDeviceReport(Capabilities.InputReportByteLength, FastRead(timeout));
		}
		...
		public async Task<HidDeviceReport> FastReadReportAsync(int timeout = 0)
		{
			var readReportDelegate = new ReadReportDelegate(FastReadReport);
#if NET20 || NET35 || NET5_0_OR_GREATER
